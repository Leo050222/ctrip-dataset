// var i = Math.random();  
// var url = 'https://flights.ctrip.com/international/search/api/search/batchSearch'
// url = url + "?v=" + i;


// var a = t.transactionID + e
// , o = "bomb__".concat(a);

// r = window.sessionStorage.getItem(o)
...
const config = require('./data.json',encoding="utf-8");
var e = config.transaction_id
var dep = config.departure,arr = config.arrival,time = config.departure_date
...
var sign = Cryptojs.MD5(e+dep+arr+time).toString()
console.log(e)
